...
function NavBar() {
  ...
  const home = <AiOutlineHome className="self-center text-sky-700" />;
  const about = <AiOutlineHistory className="self-center text-sky-700" />;
  const contact = <AiOutlineContacts className="self-center text-sky-700" />;
  const help = <AiOutlineQuestion className="self-center text-sky-700" />;
  const link = (
    <AiOutlineLink className="self-center text-sky-700 text-lg hover:scale-110" />
  );
  ...
  return (
    <nav className="sticky top-0 bg-sky-50 backdrop-blur-lg border-b-2 z-20 flex justify-between px-5 md:px-10 lg:px-20 xl:px-36 py-2 lg:py-4 shadow-md">
      {/* Logo */}
